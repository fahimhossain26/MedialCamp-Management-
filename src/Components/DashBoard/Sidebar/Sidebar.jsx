          ...
          <div className='block cursor-pointer p-4 font-bold'>
            <Link>
              <img
                ...
                src='https://i.postimg.cc/tgg5TbKL/Blue-Minimalist-Health-Logossss-removebg-preview.png'
                alt='logo'
                width='50'
                height='50'
              />
        ...
        <div>
          ...
          <div className='flex flex-col justify-between flex-1 mt-6'>
            ...
            <nav>
              ...
              {/* Add Camp*/}
              {/* <MenuItem  label='Add Camp' address='add-camp' icon={MdHomeWork} ></MenuItem> */}
              
              {/* My Listing */}
              {/* <MenuItem  label='My Listings' address='my-listing' icon={FaListCheck} ></MenuItem> */}  
