...
const SingleCamp = ({camp}) => {
    const { _id, campFees,price,campName, description, image, location,professionalName ,title} = camp
    return (
        <div className="card w-96 bg-base-100 shadow-xl">
      <figure><img src={image} alt="Shoes" /></figure>
      <div className="card-body">
        <h2 className="card-title mx-auto text-3xl font-mono font-bold text-orange-500 mb-2">{title} </h2>
        <p>{description }</p>
